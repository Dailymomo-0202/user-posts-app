...
1. On first visit to `/users`, the app checks whether the local database is empty.
2. If empty, it fetches all users and posts from JSONPlaceholder's REST API and stores them in the local H2 database.
